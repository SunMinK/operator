...
public class OpExample {
	...
	// 기능 실행용 메소드 method : 객체 지향 프로그래밍에서
	// 객체와 관련된 서브루틴 or 함수
	public void ex1( ) {
	...
	public void ex3() {
	  ...
	  public void ex4() {
		  ...
		  System.out.println("temp는 짝수?" + (temp % 2 == 0)); //false == 0이 아님(짝수가 아님)
	  ...
	  public void ex5 () {
		 ...
		 // ||(또는) : 둘다 false 면 false (AND의 반대) 나머지 true
		 int c = 10;
		 // c는 10을 초과했거나 짝수인가?
